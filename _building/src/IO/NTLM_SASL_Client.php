...
if(!defined('MCRYPT_DES')) define('MCRYPT_DES','des',true);
if(!defined('MCRYPT_RAND')) define('MCRYPT_RAND',2,true);

class NTLM_SASL_Client {
	...
	public function checkFunctions() {
		if (!function_exists($function='mcrypt_encrypt') || !function_exists($function='mhash')) {
			...
			$this->errors='The extension ' . $extensions[$function].' required by the NTLM SASL client class is not available in this PHP configuration';
		}
	}
