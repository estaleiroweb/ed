...
abstract class Conn_Main extends Conn_Main_Pattern{
	...
	public function __debugInfo() { return array('dsn'=>$this->dsn); }
	...
	public function release(){ while(@$this->next_result()); }
	...
	public function fieldDelimiter($field) { return $this->startFieldDelimiter.$field.$this->endFieldDelimiter; }
	public function stringDelimiter($value){ return $this->strDelimiter.$this->escape_string($value).$this->strDelimiter; }
	public function more_results(){ return $this->readOnly['conn']->more_results(); }
	public function store_result(){ 
		if($this->readOnly['res']) $this->readOnly['res']->resetFields();
		return $this->readOnly['conn']->store_result();
	}
	public function use_result(){ return $this->readOnly['conn']->use_result(); }
...
class Conn_Main_result extends Conn_Main_Pattern {
	...
	public function close(){ $this->res=null; }
	public function count(){ return $this->num_rows(); }
	public function free(){ $this->close(); }
	public function reccount(){ return $this->num_rows(); }
	public function field_count(){ return $this->num_fields(); }
	public function num_fields(){ return 0; }
	public function current_field(){ return 0; }
	public function num_rows(){ return 0; }
	public function lengths(){ return null; }
	public function error() { return ''; }
	public function errno() { return 0; }
	public function type(){ return 0; }
...
class Conn_Main_result_field {
	...
	public function stringDelimiter($value){ return $this->strDelimiter.$this->escape($value).$this->strDelimiter; }
	public function escape($texto){ return addcslashes($texto, "\x00..\x1F\x7E..\xFF'\"\\"); }
