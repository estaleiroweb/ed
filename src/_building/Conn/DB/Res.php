...
abstract class Res extends Error {
	...
	function verifyError(){ if($this->verifyError && $this->error()) $this->fatalError(); }
	function fatalError(){
	...
	function close(){ $this->res=null; }
	function count(){ return $this->num_rows(); }
	function free(){ $this->close(); }
	function reccount(){ return $this->num_rows(); }
	function field_count(){ return $this->num_fields(); }
	function num_fields(){ return 0; }
	function current_field(){ return 0; }
	function num_rows(){ return 0; }
	function lengths(){ return null; }
	function error() { return ''; }
	function errno() { return 0; }
