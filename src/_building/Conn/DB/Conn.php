...
class Conn{
	...
	private static function buildCaller($scheme){
		...
		switch(strtolower($scheme)) {
			case 'mysqli':                  $nm='MySQLi';break;
			case 'mysql':                   $nm='MySQL';break;
			case 'mssqlora':                $nm='MSSQL_ORA';break;
			case 'ms-sql-s': case 'mssql':  $nm='MSSQL';break;
			case 'ora':      case 'oracle': $nm='Oracle';break;
			default: trigger_error('Scheme Database unknown: '.$scheme,E_USER_ERROR); 
		}
