...
class CmdStdIO {
	...
	/**
	 * Change / restore a style of CmdStdIO
	 ...
	 * @return string Return a special string to print to change style CmdStdIO
	 * @example self
	 * ```php
	 * $c=new CmdStdIO;
	...
	/**
	 * Build a special string to style of the CmdStdIO
	 *
	...
	/**
	 * Create a menu options on CmdStdIO
	 * 
